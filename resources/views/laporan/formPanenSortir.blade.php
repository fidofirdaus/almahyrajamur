...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Laporan Panen Sortir Petani</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ URL('/admin') }}">Home</a></li>
                <li class="breadcrumb-item active">Laporan Panen Sortir Petani</li>
            </ol>
        </div>
    </div>
    <div class="row">
        ...
        <div class="card col-md-12">
            <div class="card-body">
                ...
                @endif
                <h4 class="card-title">Data Laporan Panen Sortir Petani</h4>
                <form action="{{ route('laporan.printPanenSortir') }}" target="_blank" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="id_petani" class="select2 @error('id_petani') is-invalid @enderror" style="width: 100%">
                                    ...
                                    <option value="{{ $panen->id_petani }}">{{ $panen->petani->name }} (Lokasi: {{ $panen->petani->lokasi }})</option>
                                    @endforeach
                                </select>
                                @error('id_petani')
